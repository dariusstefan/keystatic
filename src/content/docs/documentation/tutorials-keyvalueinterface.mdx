...
* store - [cache_store()](/documentation/script-corefunctions#toc101)
* fetch - [cache_fetch()](/documentation/script-corefunctions#toc102)
* remove - [cache_remove()](/documentation/script-corefunctions#toc103)
* add - [cache_add()](/documentation/script-corefunctions#toc104)
* sub - [cache_sub()](/documentation/script-corefunctions#toc105)
...
* cachedb_memcached : The Memcached module exports a parameter to script, [cachedb_url](http://www.opensips.org/html/docs/modules/devel/cachedb_memcached.html#id249176) . The prefix part of the URL provided ( the part before :// ) will be the ENGINE_ID identifier that will be provided to the functions in the API
* cachedb_redis : Similar to the memcached module, the Redis module exports a parameter to script, [cachedb_url](http://www.opensips.org/html/docs/modules/devel/cachedb_redis.html#id249095) . The prefix part of the URL provided ( the part before :// ) will be the ENGINE_ID identifier that will be provided to the functions in the API
