...
You can find the all the new additions in 1.5.x release compiled [under this page](/about/version-1-5-0). Overviewing it, may help you understanding the migration / update process.
