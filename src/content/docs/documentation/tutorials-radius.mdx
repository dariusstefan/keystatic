...
For more information about that and more, check [ACC AAA flags](http://www.opensips.org/html/docs/modules/devel/acc.html#id271395) .
...
There are other optional flags and parameters you may want to use, depending on your purpose. For more information about them, check [AUTH_AAA flags](http://www.opensips.org/html/docs/modules/devel/auth_aaa.html#id227283).
...
The right-hand side of the assignment must be a script pseudo variable or a script AVP. For more information about them see [Documentation - Scripting Variables](/documentation/index#toc5).
For example:
