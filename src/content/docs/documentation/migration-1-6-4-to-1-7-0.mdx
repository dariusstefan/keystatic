...
You can find the all the new additions in 1.7.0 release compiled [under this page](/about/version-1-7-0). Overviewing it, may help you understanding the migration / update process.
