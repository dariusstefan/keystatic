...
You can find the all the new additions in the **1.11.0** release compiled [under this page](/about/version-1-11-0). The changelog may help your understanding of the migration / update process.
