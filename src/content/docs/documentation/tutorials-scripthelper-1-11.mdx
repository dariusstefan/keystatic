...
subtitleHref: "http://www.opensips.org/html/docs/modules/1.12.x/script_helper.html"
...
As stated in the [documentation](http://www.opensips.org/html/docs/modules/1.12.x/script_helper.html), the module currently features:
...
* also acts as a SIP registrar
 ...
 Table: @@green|**Scripting examples**@@
<table>
<thead><tr>
<th>With Script Helper</th>
<th>Classic Script</th>
</tr></thead>
<tbody><tr>
<td><pre><code>{`####### Global Parameters #########
