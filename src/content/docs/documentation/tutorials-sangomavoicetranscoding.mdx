...
@@red|As mentioned in the [module documentation](http://www.opensips.org/html/docs/modules/2.2.x/sngtc.html), transcoding may only be done if the UAC performs early SDP negotiation and the UAS supports late SDP negotiation.@@
...
All functions properly handle retransmissions. More details can be found in the [module documentation](http://www.opensips.org/html/docs/modules/devel/uri.html). A basic configuration file is shown below:
