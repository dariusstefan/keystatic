...
You can find the all the new additions in 1.6.x release compiled [under this page](/about/version-1-6-0). Reading it may help you understand the migration / update process.
