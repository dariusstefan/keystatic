...
You can find the all the new additions in 1.9.0 release compiled [under this page](/about/version-1-9-0). Overviewing it may help you understanding the migration / update process.
