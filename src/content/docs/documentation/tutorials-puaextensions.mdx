...
See here a [configuration file example](/documentation/tutorials-presence-puausrlocconfig).
...
You can read the [modules readme here](http://www.opensips.org/html/docs/modules/1.11.x/pua_usrloc.html).
...
presence state of a resource through the MI interface. This module requires the **pua** core and at least one [MI backend module](http://www.opensips.org/Documentation/Interface-MI-1-11).
...
```
You can read the [modules readme here](http://www.opensips.org/html/docs/modules/1.11.x/pua_mi.html).
...
See a [configuration example here](/documentation/tutorials-presence-puaxmppconfig).

You can read the [module readme here](http://www.opensips.org/html/docs/modules/1.11.x/pua_xmpp.html).
...
See here a [configuration file example](/documentation/tutorials-presence-puablaconfig).

You can read the [module readme here](http://www.opensips.org/html/docs/modules/1.11.x/pua_bla.html).

---

@@anchor|pua_dialoginfo@@
## pua_dialoginfo
...
See here a [configuration file example](/documentation/tutorials-presence-puadialoinfoconfig).

You can read the [modules readme here](http://www.opensips.org/html/docs/modules/1.11.x/pua_dialoginfo.html).
