...
[http://www.opensips.org/images/presence-schema-small.jpg](/documentation/tutorials-presence-presencediagram)

---

## Module Description

* [PRESENCE module](/documentation/tutorials-presence-presencemodule) - a general, event package independent Subscribe, Publish handler – Notify generator according to RFCs 3265 and 3903
* [PRESENCE_XML and PRESENCE_MWI modules](/documentation/tutorials-presence-presenceauxmodules) - clients for PRESENCE module; register specific events to be handled by PRESENCE module:
...
* [XCAP_CLIENT module](/documentation/tutorials-presence-xcapclient) -  an XCAP client interface with data retrieving functionality only, for OpenSIPS modules.

---

## Configuration
The architecture in the [diagram](/documentation/tutorials-presence-presencediagram) corresponds to a full configuration, when no restrictions are imposed, with privacy permission rules handling enabled and the use of a general XCAP server. 
...
You can see a [configuration file example for this case here](/documentation/tutorials-presence-simplepresconfig).
...
See [configuration file example](/documentation/tutorials-presence-openxcappresconfig) here.
