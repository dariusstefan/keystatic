...
The [*aaa_diameter*](https://opensips.org/docs/modules/3.2.x/aaa_diameter.html) OpenSIPS connector module makes use of the *libfdcore.so* and *libfdproto.so* shared libraries.  These libraries can be installed via:
