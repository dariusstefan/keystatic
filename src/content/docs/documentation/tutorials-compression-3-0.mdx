...
subtitleHref: "http://www.opensips.org/html/docs/modules/3.0.x/compression.html"
...
As stated in the [documentation](http://www.opensips.org/html/docs/modules/3.0.x/compression.html), the module currently features:
* **Message compaction**
