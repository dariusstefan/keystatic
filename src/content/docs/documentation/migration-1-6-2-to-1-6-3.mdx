...
You can find the all the new additions in 1.6.3 release compiled [under this page](/about/version-1-6-3). Reading it may help you understand the migration / update process.
