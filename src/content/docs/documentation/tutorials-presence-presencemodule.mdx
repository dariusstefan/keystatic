...
Please refer to the [module's documentation](http://www.opensips.org/html/docs/modules/1.11.x/presence.html) for the full list of parameters and a comprehensive description.
