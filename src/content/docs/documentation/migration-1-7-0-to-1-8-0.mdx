...
You can find the all the new additions in 1.8.0 release compiled [under this page](/about/version-1-8-0). Overviewing it may help you understanding the migration / update process.
...
* Because of a large part of the TEXTOPS module was split to the SIPMSGOPS module, some functions that used to be in the TEXTOPS module will not reside in SIPMSGOPS. Please check the [SIPMSGOPS](http://www.opensips.org/html/docs/modules/devel/sipmsgops.html) documentation for the list of exported functions, and also load the SIPMSGOPS module, if needed. 
