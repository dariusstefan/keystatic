...
The **MI** commands are provided by the OpenSIPS core (see [full list](/manual/devel/interface-coremi)) and also by modules (check the commands provided by [each module](/manual/devel/modules)).
