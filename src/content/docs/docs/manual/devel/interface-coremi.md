...
**Arguments**:
* *level* (optional) - logging level (-3...4) (see [meaning of the values](/manual/devel/script-coreparameters#log_level))
...
Also see the [E_PROFILING_PROC event](/manual/devel/interface-coreevents#E_PROFILING_PROC) used for reporting the profiling data.
