...
The *log_event_level_filter* should be used in concordance with the [log_level](/manual/devel/script-coreparameters#log_level) parameter, i.e. a level lower than *log_level*.
...
The value of the *log_level* parameter can also be get and set dynamically using the [log_level](/manual/devel/interface-coremi#log_level) Core MI function or [`$log_level`](/manual/devel/script-corevar#log_level) script variable.
...
The *stderror_level_filter* should be used in concordance with the [log_level](/manual/devel/script-coreparameters#log_level) parameter, i.e. a level lower than *log_level*.
...
*Setting [tcp_keepcount](/manual/devel/script-coreparameters#toc99) to any value will enable [tcp_keepalive](/manual/devel/script-coreparameters#toc98).*
...
*Setting [tcp_keepidle](/manual/devel/script-coreparameters#toc100) to any value will enable [tcp_keepalive](/manual/devel/script-coreparameters#toc98).*
...
*Setting [tcp_keepinterval](/manual/devel/script-coreparameters#toc101) to any value will enable [tcp_keepalive](/manual/devel/script-coreparameters#toc98).*
