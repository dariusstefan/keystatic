...
**Arguments**:
* *level* (optional) - logging level (-3...4) (see [meaning of the values](/manual/4-0/script-coreparameters#log_level))
...
Also see the [E_PROFILING_PROC event](/manual/4-0/interface-coreevents#E_PROFILING_PROC) used for reporting the profiling data.
