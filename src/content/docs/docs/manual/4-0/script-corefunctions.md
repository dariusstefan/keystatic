...
For more see [Flags Documentation](/manual/4-0/script-flags).
...
For more about script flags, see [Flags Documentation](/manual/4-0/script-flags).
...
This function checks if a SIP socket is part of a certain bond socket (see the [definition of a bond socket](/manual/4-0/script-coreparameters#socket)).
