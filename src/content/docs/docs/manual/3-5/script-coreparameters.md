...
This parameter was replaced by the [syslog_facility](/manual/3-5/script-coreparameters#syslog_facility) parameter, preserving exactly the same format and behavior.
...
The *log_event_level_filter* should be used in concordance with the [log_level](/manual/3-5/script-coreparameters#log_level) parameter, i.e. a level lower than *log_level*.
...
The value of the *log_level* parameter can also be get and set dynamically using the [log_level](/manual/3-5/interface-coremi#log_level) Core MI function or [`$log_level`](/manual/3-5/script-corevar#log_level) script variable.
...
This parameter was replaced by the [syslog_name](/manual/3-5/script-coreparameters#syslog_name) parameter, preserving exactly the same format and behavior.
...
This parameter is deprecated and it's behavior starting with OpenSIPS 3.4 is equivalent to setting the [stderror_enabled](/manual/3-5/script-coreparameters#stderror_enabled) and [syslog_enabled](/manual/3-5/script-coreparameters#syslog_enabled) parameters, as following:
...
The *stderror_level_filter* should be used in concordance with the [log_level](/manual/3-5/script-coreparameters#log_level) parameter, i.e. a level lower than *log_level*.
...
*Setting [tcp_keepcount](/manual/3-5/script-coreparameters#toc99) to any value will enable [tcp_keepalive](/manual/3-5/script-coreparameters#toc98).*
...
*Setting [tcp_keepidle](/manual/3-5/script-coreparameters#toc100) to any value will enable [tcp_keepalive](/manual/3-5/script-coreparameters#toc98).*
...
*Setting [tcp_keepinterval](/manual/3-5/script-coreparameters#toc101) to any value will enable [tcp_keepalive](/manual/3-5/script-coreparameters#toc98).*
