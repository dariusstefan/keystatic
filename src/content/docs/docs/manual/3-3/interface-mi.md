...
The **MI** commands are provided by the OpenSIPS core (see [full list](/manual/3-3/interface-coremi)) and also by modules (check the commands provided by [each module](/manual/3-3/modules)).
