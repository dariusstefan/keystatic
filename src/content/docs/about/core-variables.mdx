...
$(@@green|<context>name(subname)[index]{transformation}@@)
...
> **Caution:** TO BECOME OBSOLETE, replaced by [$msg.branch.flags](#msg.branch.flags)

### Branch - $branch 

**$branch** - this variable is used for creating new branches by writing into it the value of a SIP URI.  

> **Caution:** TO BECOME OBSOLETE, replaced by [$msg.branch.uri](#msg.branch.uri)
Examples:
```c
...
> **Caution:** TO BECOME OBSOLETE, replaced by [$msg.branch.flag](#msg.branch.flag)
