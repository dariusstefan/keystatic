...
<Badge variant="caution">It is R/W variable (you can assign values to it from routing logic)</Badge>
...
<Badge variant="caution">It is R/W variable (you can assign values to it routing script)</Badge>
