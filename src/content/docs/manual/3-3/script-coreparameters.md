...
The *log_level* parameter is usually used in concordance with the [log_stderror](/manual/3-3/script-coreparameters#log_stderror) parameter.

The value of the *log_level* parameter can also be get and set dynamically using the [log_level](/manual/3-3/interface-coremi#log_level) Core MI function or [`$log_level`](/manual/3-3/script-corevar#log_level) script variable.
...
*Setting [tcp_keepcount](/manual/3-3/script-coreparameters#toc99) to any value will enable [tcp_keepalive](/manual/3-3/script-coreparameters#toc98).*
...
*Setting [tcp_keepidle](/manual/3-3/script-coreparameters#toc100) to any value will enable [tcp_keepalive](/manual/3-3/script-coreparameters#toc98).*
...
*Setting [tcp_keepinterval](/manual/3-3/script-coreparameters#toc101) to any value will enable [tcp_keepalive](/manual/3-3/script-coreparameters#toc98).*
