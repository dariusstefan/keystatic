...
For more see [Flags Documentation](/manual/devel/script-flags).
...
For more about script flags, see [Flags Documentation](/manual/devel/script-flags).
...
This function checks if a SIP socket is part of a certain bond socket (see the [definition of a bond socket](/manual/devel/script-coreparameters#socket)).
