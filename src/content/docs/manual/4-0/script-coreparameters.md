...
The *log_event_level_filter* should be used in concordance with the [log_level](/manual/4-0/script-coreparameters#log_level) parameter, i.e. a level lower than *log_level*.
...
The value of the *log_level* parameter can also be get and set dynamically using the [log_level](/manual/4-0/interface-coremi#log_level) Core MI function or [`$log_level`](/manual/4-0/script-corevar#log_level) script variable.
...
The *stderror_level_filter* should be used in concordance with the [log_level](/manual/4-0/script-coreparameters#log_level) parameter, i.e. a level lower than *log_level*.
...
*Setting [tcp_keepcount](/manual/4-0/script-coreparameters#toc99) to any value will enable [tcp_keepalive](/manual/4-0/script-coreparameters#toc98).*
...
*Setting [tcp_keepidle](/manual/4-0/script-coreparameters#toc100) to any value will enable [tcp_keepalive](/manual/4-0/script-coreparameters#toc98).*
...
*Setting [tcp_keepinterval](/manual/4-0/script-coreparameters#toc101) to any value will enable [tcp_keepalive](/manual/4-0/script-coreparameters#toc98).*
