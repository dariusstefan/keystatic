...
Usage:
    python3 pmwiki-mdx/gen_nav.py pmwiki-mdx/test-output > src/sidebar.mjs
"""
...
def main():
    root = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("pmwiki-mdx/test-output")
    ...
    print("// AUTO-GENERATED by pmwiki-mdx/gen_nav.py — do not edit by hand")
    print("// Run: python3 pmwiki-mdx/gen_nav.py pmwiki-mdx/test-output > src/sidebar.mjs")
    print()
