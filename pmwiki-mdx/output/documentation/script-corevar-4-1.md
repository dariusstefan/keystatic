...
**$log_level** - changes the log level for the current process ; the log level can be set to a new value (see [possible values](/documentation/script-coreparameters-4-1#log_level) or it can be reset back to the global log level.
